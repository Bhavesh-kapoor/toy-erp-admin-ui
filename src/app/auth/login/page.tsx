      ...
      {!token && (
        <div className="flex items-center justify-center h-screen w-full">
          <div className="flex flex-col lg:h-screen h-full lg:flex-row justify-center items-center lg:gap-20">
            <div className="w-full lg:w-1/2 order-1 lg:order-2 lg:bg-primary/10 lg:h-screen flex items-center justify-center">
              ...
              <div className="p-5 pt-3">
                ...
                <form onSubmit={handleSubmit}>
                  <input
                    ...
                    className="w-full p-3 border-b border-b-gray-300 focus:outline-none focus:border-primary"
                    onChange={(e) => setEmail(e.target.value)}
                  />
                  <div className="flex mt-5 justify-between items-center border-b border-gray-300 focus:outline-none focus:border-primary p-3 mb-5">
                    <input
                      value={password}
